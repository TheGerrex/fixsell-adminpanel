...
@Component({
  selector: 'app-printersregister',
  templateUrl: './printersregister.component.html',
  styleUrls: ['./printersregister.component.scss']
})
export class PrintersregisterComponent {
  ...
  printerregister() {
     ...
     this.http.post('http://localhost:3000/printers', bodyData, {responseType:"text"}).subscribe((data: any) => {
      console.log(data);
